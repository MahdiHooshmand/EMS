...
class EMS extends Electrotherapy {
  private static readonly validFrequencies = [
    500, 600, 700, 800, 900, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000,
    9000, 10000,
  ];
  private static readonly validPulseWidths = [300, 500];
...
class TENS extends Electrotherapy {
  private static readonly validFrequencies = [
    2, 3, 4, 5, 6, 7, 8, 9, 10, 15, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90,
    100, 110, 120,
  ];
  private static readonly validPulseWidths = [50, 75, 100, 150, 200, 250, 300];
